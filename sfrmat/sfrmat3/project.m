...
%            8 May 2000   fac input arguement added
%            13 Jan. 2020 angle-correction added  following suggestion by
%                         Rowin Zhuang, DJI Company
%            3 July 2020  obove correction removed/commentede
% Copyright (c) Peter D. Burns 1998-2020
%
status =0;
[nlin, npix]=size(bb);
...
% 13 Jan. 2020 Following suggestion by Rowin Zhuang
%  ling =  ceil((x - y*sin(theta))*fac) + 1 - offset;
% However, this implemenation appears not to be correct
